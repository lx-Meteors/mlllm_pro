...
python prepare_data.py --work_dir 'compressLLM_baseline_ratio_5'
python ./trainer.py --work_dir 'compressLLM_baseline_ratio_5' --port 14522
python ./evaluator.py --work_dir 'compressLLM_baseline_ratio_5' --batch_size 1
# bash train.sh