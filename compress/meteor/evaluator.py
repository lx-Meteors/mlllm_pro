...
def parse_args():
    ...
    parser.add_argument('--work_dir', type=str, default="compressLLM_baseline_len-510_ratio-5_wo-ae",required=False, help='Directory including the configuration file')
